"""
Конфигурация для VK Community Bot с RAG на основе ProxyAPI.
...
if not VK_API_TOKEN:
    raise ValueError("VK_API_TOKEN не установлен в переменных окружения!")

# ID группы ВКонтакте
VK_GROUP_ID = os.getenv("VK_GROUP_ID", "")
if not VK_GROUP_ID:
    raise ValueError("VK_GROUP_ID не установлен в переменных окружения!")

# ========== PROXY API НАСТРОЙКИ ==========
# URL кастомного API endpoint (совместимый с OpenAI API)
# Примеры:
...
8. НЕ используй html разметку при ответах никогда!
"""
